...
<div className="">
    ...
    <nav className="pagination-top flex items-center -space-x-px ml-[700px] mt-[-1.5rem] mb-1" aria-label="Pagination">
        ...
        <table className="bg-white rounded-lg ml-56 overflow-hidden w-[79rem]" style={{ tableLayout: 'fixed' }}>
  <thead className="bg-blue-400 text-xs">
    <tr className="text-white">
      <th className="px-4 py-2 text-left font-normal rounded-l-lg" style={{ width: '10%' }}>First Name</th>
      <th className="px-4 py-2 text-left font-normal" style={{ width: '10%' }}>Middle Name</th>
      <th className="px-4 py-2 text-left font-normal" style={{ width: '10%' }}>Last Name</th>
      <th className="px-4 py-2 text-left font-normal" style={{ width: '10%' }}>Contact</th>
      <th className="px-4 py-2 text-left font-normal" style={{ width: '10%' }}>Region</th>
      <th className="px-4 py-2 text-left font-normal" style={{ width: '10%' }}>City</th>
      <th className="px-4 py-2 text-left font-normal" style={{ width: '10%' }}>Brgy</th>
      <th className="px-4 py-2 text-left font-normal" style={{ width: '10%' }}>Street</th>
      <th className="px-4 py-2 text-center font-normal rounded-r-lg" style={{ width: '20%' }}>Actions</th>
    </tr>
  </thead>
